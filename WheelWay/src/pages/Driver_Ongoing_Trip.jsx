  ...
  return (
    <>
      {!metRider && 
        ...
        <img src={profileIcon} className='select-none relative top-[14%] h-[60px] left-[5%]'/>
      ...
      <p className='text-[24px] text-bold top-[10%] left-[5%] relative'>You're riding with:</p>
      <img src={profileIcon} className='select-none relative top-[14%] h-[55px] left-[5%]'/>
      <p className='text-[16px] text-bold top-[18%] left-[6%] relative'>Name:</p>
      <p className='text-[16px] text-bold top-[20%] left-[6%] relative'>Mobile Number:</p>
      <p className='text-[16px] text-bold top-[22%] left-[6%] relative'>Pickup: {tripData.Pickup}</p>
      <p className='text-[16px] text-bold top-[24%] left-[6%] relative'>Dropoff: {tripData.Dropoff}</p>
      ...
      <div className="w-[25%] h-[50%] bg-primary text-whitish z-40 absolute top-[30%] left-[50%] -translate-x-1/2 transform drop-shadow-md z-50 rounded-[20px] p-4">
        <p className='text-[20px] font-bold mb-2'>Please help your rider out of the vehicle</p>
        ...
        <div className="flex-auto">
          <Rating className='w-8' unratedColor="amber" ratedColor="amber" />
        </div>
        <button
          onClick='{}'
          className='bg-accent w-full h-[10%] text-primary text-[26px] font-bold transform transition ease-in-out delay-150 drop-shadow-md z-50 rounded-[5px] hover:-translate-y-1/4 hover:text-whitish mt-4'>
            Start the trip
        </button>
      </div>
