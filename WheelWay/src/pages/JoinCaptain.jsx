...
const JoinCaptain = () => {
    return (
      <>
      <div className=''>
      <h1 className="text-[36px] font-bold flex items-center justify-center h-auto sm:text-[48px] mt-[10px] text-primary">Join AidDrive as a Captain</h1>
      ...
      At AidDrive, we believe that mobility should be accessible to everyone, regardless of physical challenges.<br></br> 
      ...
      <p className='relative left-[130px] '>Why Drive with AidDrive?</p>
      ...
      AidDrive adapts to your lifestyle.</li>
      </ul>
      ...
      <p className='relative left-[130px] '>Join AidDrive today and drive with purpose. Together, we’ll create a world where everyone can move forward, one ride at a time.</p>
      </div>
