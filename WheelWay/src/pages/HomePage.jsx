...
const Home = () => {
  ...
  return (
    <>
    <div className=''>
    <h1 className="text-[36px] font-bold flex items-center justify-center h-auto sm:text-[48px] mt-[30px] text-primary">WHEEL WAY</h1>
    ...
    <p className="sm:text-[20px] text-primary/75 relative top-[80px] text-[16px] justify-end ml-[20px] sm:left-[130px] whitespace-pre; w-[900px] h-[120px]">
      Welcome to Wheel Way, where mobility knows no bounds. 
    ...
    <li className='text-balance w-[450px] mb-[10px] sm:mb-[0px] sm:text-nowrap'>On-Demand Service: Need a ride? Just open the website!<br></br> Wheel Way connects you
    ...
    <p className='relative left-[170px]'>Why Choose Wheel Way:</p>
