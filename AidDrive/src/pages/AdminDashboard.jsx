    ...
    <div className='bg-whitish w-[55%] h-[550px] rounded-[5px] fixed left-[25%] top-[10%]'>
        {
            ...
            <div className=' hover:-translate-y-1 hover:text-whitish hover:scale-110 fixed bottom-[60%] left-[45%] transition ease-in-out delay-150 w-[110px] h-[40px] bg-accent text-primary font-bold hover:font-bold text-[18px]  rounded-[5px] '>
                <Link to='' className='relative top-[20%] left-[25%] '>Search</Link>
            </div>
            </>
        ...
        }
        {
            ...
            <button className='fixed outline outline-2 outline-accent bg-secondary bottom-[15%] right-[22%] h-[50px] w-[150px] text-primary font-bold'>SUBMIT</button> 
