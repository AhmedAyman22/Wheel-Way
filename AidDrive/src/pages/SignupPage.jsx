...
const SignupPage = () => {
  return (
    ...
    <form onSubmit={formSubmission} className='bg-secondary h-[550px] w-[500px] rounded-[20px] absolute left-20 inline-block '>
    <p className='m-0 font-bold text-primary pl-10 mt-5'>First Name:</p>
    <input id="firstName" type="text" maxLength="16" className='w-[420px] h-[30px] ring-[5px] ring-accent rounded-[2px] relative mt-2 ml-10 hover:-translate-y-1 transition ease-in-out delay-150'/>
    <p className='m-0 font-bold text-primary pl-10 mt-5'>Last Name:</p>
    <input id="lastName" type="text" maxLength="16" className='w-[420px] h-[30px] ring-[5px] ring-accent rounded-[2px] relative mt-2 ml-10 hover:-translate-y-1 transition ease-in-out delay-150'/>
    <p className='m-0 font-bold text-primary pl-10 mt-5'>Email Address:</p>
    <input id="email" type="email" maxLength="32" className='w-[420px] h-[30px] ring-[5px] ring-accent rounded-[2px] relative mt-2 ml-10 hover:-translate-y-1 transition ease-in-out delay-150'/>
    <p className='m-0 font-bold text-primary pl-10 mt-5'>Password:</p>
    <input id="password" type="password" maxLength="16" className='w-[420px] h-[30px] ring-[5px] ring-accent rounded-[2px] relative mt-2 ml-10 hover:-translate-y-1 transition ease-in-out delay-150'/>
    <p className='m-0 font-bold text-primary pl-10 mt-5'>Confirm Password:</p>
    <input id="passwordConfirmation" type="password" maxLength="16" className='w-[420px] h-[30px] ring-[5px] ring-accent rounded-[2px] relative mt-2 ml-10 hover:-translate-y-1 transition ease-in-out delay-150'/>
    ...
    <div className='bg-secondary h-[550px] w-[500px] rounded-[20px] absolute right-20 inline-block'>
    ...
    <span className='text-[14px] font-bold left-[50px] h-auto sm:text-[18px] relative top-12 text-primary '>Please upload the following documents</span>
