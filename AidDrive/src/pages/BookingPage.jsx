...
// Geocode.setApiKey('REMOVED_SECRET');
...
//   const handleConfirm = () => {
//     // Use pickupCoordinates and dropoffCoordinates as needed
...
//           <input type="text" className='border-[2px] border-accent rounded-[5px] w-[240px] h-[40px] m-[10px] relative left-[50px] top-[30px] text-[14px] pl-[14px]' placeholder='Pickup Location'/>
//           <input type="text" className='border-[2px] border-accent rounded-[5px] w-[240px] h-[40px] m-[10px] relative left-[50px] top-[30px] text-[14px] pl-[14px]' placeholder='Dropoff Location'/>
...
//     <MapView className='drop-shadow-lg rounded-[20px] absolute top-[250px] left-[1300px] inline-block h-[600px] w-[500px]' />
...
import vipRide from '../assets/images/vipRide_icon.png';
import arrowRight from '../assets/images/arrow_right.png';
import MyMapComponent from '../components/Map'; // Import the modified map component
    ...
    <>
      <div>
        ...
        <div className='h-[600px] w-[500px] bg-whitish drop-shadow-lg rounded-[20px] absolute top-[250px] left-[700px] inline-block'>
          ...
          {/* Your ride options here */}
        </div>

        <MyMapComponent userLocation={{ lat: 31.2357, lng: 30.0444 }} /> {/* Pass the user's location here */}
      </div>
    </>
  );
}
