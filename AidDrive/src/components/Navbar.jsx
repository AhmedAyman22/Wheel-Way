...
const Navbar = () => {
    return (
      ...
      {/* <a className='absolute h-7 w-18 inset-y-[25px] right-[255px] font-semibold hover:cursor-pointer'>TRIPS</a>
      <a className='absolute h-7   w-18 inset-y-[25px] right-[140px] font-semibold hover:cursor-pointer'>ORDER</a> */}
      <button className='absolute h-[35px] w-[100px] inset-y-[22px] right-[15px] rounded-md bg-accent text-primary font-bold hover:-translate-y-1 hover:scale-110 transition ease-in-out delay-150 hover:bg-opacity-85 hover:text-whitish'>SIGNUP</button>
</nav>
  )
}
