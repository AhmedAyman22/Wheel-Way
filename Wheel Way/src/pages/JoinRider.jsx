...
const JoinRider = () => {
    return (
      <>
      <div className=''>
      <h1 className="text-[36px] font-bold flex items-center justify-center h-auto sm:text-[48px] mt-[10px] text-primary">Join Wheel Way as a Rider</h1>
      ...
      Welcome to Wheel Way, where accessibility meets convenience. <br></br> 
      ...
      <p className='relative left-[130px] '>Why Choose Wheel Way?</p>
      <ul className='list-inside list-disc relative left-[150px] justify'>
      <li className='text-balance w-[450px] mb-[10px] sm:mb-[0px] sm:text-nowrap '>Tailored Rides: Wheel Way connects you with trained drivers and wheelchair-accessible vans.<br></br>
      ...
      destination, and any special requirements. Wheel Way takes care of the rest.</li>
      ...
      <li className='text-balance w-[450px] mb-[10px] sm:mb-[0px] sm:text-nowrap '>Sign Up: Create your Wheel Way account in minutes.</li>
      ...
      <p className='relative left-[130px] '>Open the Wheel Way website and experience transportation that’s reliable, compassionate, and tailored to your needs. <br></br> Let’s move forward together!</p>
      </div>
